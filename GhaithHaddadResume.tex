...
%\address{423 Silverton Pl., Piscataway, NJ}
\address{          407.601.9424 - haddad@ieee.org}

\begin{resume}
 
\section{OBJECTIVE}
A challenging position in Computer Engineering/Computer Science.
...
{\sl Programming languages:} Java, Swing, J2EE, JML, Python, C,C\#, C++, Visual
Basic 6 and .NET, Oz. \\
{\sl Database:} HBase, MySQL, ORACLE, MS-Access, SQL Server. \\
{\sl Hardware Design:} Verilog. \\
{\sl Embedded Programming:} Microchip, Freescale, ST. \\
{\sl Internet programming:} HTML, XML, Python, Perl, AJAX, Javascript. \\
{\sl Operating systems:} Windows, Linux, Palm OS. \\
{\sl Networks Programming:} TCP/IP, 802.15.4 (Zigbee). \\
{\sl ALM:} TeamForge, Jira, HPQC, ClearQuest. \\
...
Capital One Financials, Wilmington, DE \\
  \textit{Architecture \& Design, Java, Agile Development.}
  \begin{itemize} \itemsep -2pt % reduce space between items
      \item  Lead an Agile Sprint team to deliver bank projects in the Customer 
      security domain.
      \item  Interact with stakeholders and business owners to deliver the product 
      per intent.
      \item  Recently took the role of Technical Product Owner, with more exposure to 
      business counterparts and other verticals in the organization.
 \end{itemize}
